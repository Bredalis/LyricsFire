...
<p>
  Este es un repositorio que almacena los archivos de la página de lyrics de la canción Fire de BTS.  
</p>
...
1. Clona el repositorio:
    ...
    ```
    git clone https://github.com/Bredalis/LyricsFire.git
    ```
...
4. 👉🏻 O simplemente has click <a href="https://bredalis.github.io/LyricsFire/HTML/index.html" target="_blank">aquí</a>
